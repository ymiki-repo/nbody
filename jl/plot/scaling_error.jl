...
function main()
    ...
    fig_ene_fp.ax[begin].set_ylabel(L"$\left|E(t = t_\mathrm{final}) / E(t = 0) - 1\right|$", fontsize=fig_ene_fp.fs)
    ...
    fig_elapse_err_fp.ax[begin].set_xlabel(L"$\left|E(t = t_\mathrm{final}) / E(t = 0) - 1\right|$", fontsize=fig_elapse_err_fp.fs)
