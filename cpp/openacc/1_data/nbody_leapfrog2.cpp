...
#pragma acc enter data create(pos_ptr [0:num], vel_ptr [0:num], vel_tmp_ptr [0:num], acc_ptr [0:num])
...
#pragma acc update host(pos_ptr [0:num], vel_tmp_ptr [0:num], acc_ptr [0:num])
...
// memory deallocation
#pragma acc exit data delete (pos_ptr [0:num], vel_ptr [0:num], vel_tmp_ptr [0:num], acc_ptr [0:num])
