...
#pragma acc enter data create(pos[0 : num], vel[0 : num], vel_tmp[0 : num], acc[0 : num])

    // generate initial-condition
    init::set_uniform_sphere(num, pos, vel, M_tot, rad, virial, CAST2VEL(newton));
#pragma acc update device(pos[0 : num], vel[0 : num])
...
#pragma acc update host(acc[0 : num])
...
#pragma acc update host(pos[0 : num], vel_tmp[0 : num], acc[0 : num])
...
// memory deallocation
#pragma acc exit data delete (pos[0 : num], vel[0 : num], vel_tmp[0 : num], acc[0 : num])
