...
static inline void calc_acc(
  ...
  std::for_each_n(std::execution::par, boost::iterators::counting_iterator<std::remove_const_t<decltype(Ni)>>(0U), Ni, [=](const decltype(Ni) ii) {
    // initialization
...
static inline void predict(
  ...
  std::for_each_n(std::execution::par, boost::iterators::counting_iterator<std::remove_const_t<decltype(jnum)>>(0U), jnum, [=](const decltype(jnum) jj) {
...
static inline void correct(
  ...
  std::for_each_n(std::execution::par, boost::iterators::counting_iterator<std::remove_const_t<decltype(inum)>>(0U), inum, [=](const decltype(inum) ii) {
    // set time step for this particle
...
static inline void sort_particles(const type::int_idx num, type::int_idx *__restrict tag, type::nbody *__restrict src, type::nbody *__restrict dst) {
  ...
  std::for_each_n(
      ...
      std::execution::seq,
#endif  // EXEC_SMALL_FUNC_ON_HOST
      boost::iterators::counting_iterator<std::remove_const_t<decltype(num)>>(0U), num, [=](const decltype(num) ii) {
...
static inline auto set_time_step(const type::int_idx num, type::nbody &body, const type::fp_m time_pres, const type::fp_m time_sync) {
  ...
  std::for_each_n(
      ...
      std::execution::seq,
#endif  // EXEC_SMALL_FUNC_ON_HOST
      boost::iterators::counting_iterator<std::remove_const_t<decltype(Ni)>>(0U), Ni, [=](const decltype(Ni) ii) {
